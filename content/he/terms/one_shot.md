...
פרדיגמת למידה שבה מודל לומד לבצע משימה מתוך דוגמה מסומנת אחת בלבד.
...
- זיהוי פנים עם דגימות מוגבלות
- זיהוי כתב יד
- אבחנה רפואית ממקרים נדירים

## Related Terms

- [few-shot (למידה רבת-דוגמאות)](/en/terms/few-shot-למידה-רבת-דוגמאות/)
- [zero-shot (למידה אפס-דוגמאות)](/en/terms/zero-shot-למידה-אפס-דוגמאות/)
- [meta-learning (למידת-על)](/en/terms/meta-learning-למידת-על/)
- [siamese networks (רשתות סיאמיות)](/en/terms/siamese-networks-רשתות-סיאמיות/)
