...
ג'מה היא משפחה של מודלים פתוחים, קלים וחדשניים שפותחו על ידי Google DeepMind, בהתבסס על מחקר וטכנולוגיה של גמיני.
...
- יישומי חישוב בקצה (Edge Computing)

## Related Terms

- [LLM (מודל שפה גדול)](/en/terms/llm-מודל-שפה-גדול/)
- [Gemini (גמיני)](/en/terms/gemini-גמיני/)
