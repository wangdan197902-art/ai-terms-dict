...
מונח המתאר מודלים של רשתות נוירוניות שבהם משקלים ופעילויות מיוצגים במספרים בעלי דיוק נמוך יותר כדי להפחית את גודל המודל ואת זמן האחזור.

## Key Concepts

- דחיסת מודלים
- חישוב בדיוק נמוך
- הטמעה בקצה (Edge Deployment)
- אופטימיזציית הסקה (Inference)
...
- [Distillation (זיקוק מודלים)](/en/terms/distillation-זיקוק-מודלים/)
- [TensorFlow Lite (גרסת ה-Lite של טנזור פלו)](/en/terms/tensorflow-lite-גרסת-ה-lite-של-טנזור-פלו/)
