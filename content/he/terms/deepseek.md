...
DeepSeek היא סדרת מודלי שפה גדולים שפותחו על ידי חברת DeepSeek, הידועים ביעילותם הגבוהה, יכולות הקידוד החזקות שלהם וזמינות המשקלים הפתוחים.
...
- [OpenAI (אופן איי)](/en/terms/openai-אופן-איי/)
- [ארכיטקטורת Transformer (Transformer Architecture)](/en/terms/ארכיטקטורת-transformer-transformer-architecture/)
