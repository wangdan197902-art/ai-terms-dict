...
מתייחס לאלגוריתמים או תהליכים המבצעים משימה או מחזור קבלת החלטות באיטרציה אחת בלבד, ללא שיפור איטרטיבי.
...
- רגרסיה ליניארית באמצעות משוואות נורמליות
- עיבוד אותות בזמן אמת
- כללי מיון פשוטים

## Related Terms

- [iterative (איטרטיבי)](/en/terms/iterative-איטרטיבי/)
- [gradient descent (ירידה במדרגה)](/en/terms/gradient-descent-ירידה-במדרגה/)
- [closed-form (צורה סגורה)](/en/terms/closed-form-צורה-סגורה/)
- [direct method (שיטה ישירה)](/en/terms/direct-method-שיטה-ישירה/)
