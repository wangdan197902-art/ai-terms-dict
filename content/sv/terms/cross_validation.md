...
status: "published"
language: "sv"
description: "En återsticklingsmetod som används för att utvärdera maskininlärningsmodeller på ett begränsat datamaterial genom att dela upp data i delmängder för träning och testning."
---
