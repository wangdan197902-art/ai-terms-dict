...
status: published
language: sv
description: Samträning är en semiövervakad inlärningsalgoritm där två vyer av datan
  används för att träna separata klassificerare som iterativt märker olämnad data
  åt varandra.
---
## Definition
