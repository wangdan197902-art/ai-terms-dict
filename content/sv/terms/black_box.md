...
Ett system där interna mekanismer är dolda och endast in- och utdata är observerbara.

## Key Concepts

- Tolkbarhet
- Ogenomskinlighet
- In-data-ut-data-koppling
- Förklarbar AI

## Use Cases

- Modeller för djup inlärning
- Proprietära algoritmer
- Komplexa prediktiva system

## Related Terms

- [Vit låda (White Box)](/en/terms/vit-låda-white-box/)
- [Tolkbarhet](/en/terms/tolkbarhet/)
- [Djup inlärning (Deep Learning)](/en/terms/djup-inlärning-deep-learning/)
