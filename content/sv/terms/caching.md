...
status: published
language: sv
description: Caching är en teknik för att lagra ofta åtkomstdata i ett temporärt,
  snabbt lagringslager för att minska latens och belastningen på primära datakällor.
---
## Definition
