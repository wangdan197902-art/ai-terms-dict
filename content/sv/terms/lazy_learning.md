...
status: published
language: sv
description: En inlärningsapproach som fördröjer generalisering tills klassificeringstidpunkten,
  genom att lagra träningsinstanser snarare än att bygga en explicit modell.
---
## Definition
