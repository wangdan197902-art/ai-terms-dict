...
status: published
language: sv
description: Batchnormalisering är en teknik som normaliserar lagerinsignaler över
  en minibatch för att stabilisera och påskynda träningen av neurala nätverk.
---
## Definition
