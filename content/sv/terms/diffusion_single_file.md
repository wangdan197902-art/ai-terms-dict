...
status: published
language: sv
description: Ett distributionsformat för diffusionsmodeller där alla modellvikter,
  konfigurationer och ibland även inferenskoden är sammanfogade i en enda fil för
  enkel portabilitet.
---
## Definition
