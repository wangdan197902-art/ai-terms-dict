...
status: published
language: sv
description: Kvantiserad lågrangsanpassning, en metod för att effektivt finjustera
  stora språkmodeller med hjälp av 4-bits kvantisering och lågrangsadaptrar.
---
## Definition
