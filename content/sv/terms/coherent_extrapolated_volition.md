...
Ett föreslaget mål för artificiell intelligens där systemet agerar i enlighet med människans förfinade önskningar efter idealiserad resonemangsföring.

## Key Concepts

- AI-alignment
- Värdelärande
- Idealiserade mänskliga preferenser
- Användbarhetsfunktion

## Use Cases

- Teoretisk ramverk för AGI-säkerhet
- Etiska riktlinjer för superintelligenta system
- Filosofiska diskussioner om maskinmoral

## Related Terms

- [AI-säkerhet (AI Safety)](/en/terms/ai-säkerhet-ai-safety/)
- [Värdealignment (Value Alignment)](/en/terms/värdealignment-value-alignment/)
