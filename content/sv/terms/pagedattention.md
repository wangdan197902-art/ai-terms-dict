...
status: published
language: sv
description: PagedAttention är en minneshanteringsalgoritm som anpassar koncepten
  för virtuell minnesspårning för att optimera lagring och åtkomst till Key-Value
  (KV)-cacher i transformer-modeller.
---
## Definition
