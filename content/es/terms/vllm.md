...
status: published
language: es
description: vLLM es un motor de inferencia de alto rendimiento y eficiente en memoria
  para modelos de lenguaje grandes, que utiliza PagedAttention para optimizar el uso
