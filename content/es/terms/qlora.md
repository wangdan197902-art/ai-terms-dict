...
status: published
language: es
description: Adaptación de Bajo Rango Cuantizada, un método para ajustar finamente
  grandes modelos de lenguaje de manera eficiente utilizando cuantización de 4 bits
  y adaptadores de bajo rango.
---
## Definition
