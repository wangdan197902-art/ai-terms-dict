...
status: published
language: es
description: Un marco de modelado probabilístico donde la distribución conjunta se
  forma multiplicando las salidas de múltiples modelos expertos independientes.
---
## Definition
