...
status: published
language: es
description: El co-training es un algoritmo de aprendizaje semisupervisado donde se
  utilizan dos vistas de los datos para entrenar clasificadores separados que etiquetan
  iterativamente los datos no etiquetados ent
---
## Definition
