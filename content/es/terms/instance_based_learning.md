...
status: published
language: es
description: Un enfoque de aprendizaje perezoso donde las predicciones se realizan
  comparando nuevas entradas con instancias de entrenamiento almacenadas.
---
## Definition
