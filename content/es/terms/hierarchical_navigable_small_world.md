...
status: published
language: es
description: Una estructura de datos basada en grafos que permite una búsqueda eficiente
  de vecinos más cercanos aproximados en espacios de alta dimensión.
---
## Definition
