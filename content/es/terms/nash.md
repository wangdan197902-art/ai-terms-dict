...
Se refiere al Equilibrio de Nash, un estado en la teoría de juegos donde ningún jugador puede beneficiarse cambiando su estrategia mientras los demás permanecen constantes.
...
- Entrenamiento de Redes Generativas Antagónicas (GANs)
- Coordinación de tráfico de vehículos autónomos
- Agentes de simulación económica
...
- [Zero-Sum Game (Juego de suma cero)](/en/terms/zero-sum-game-juego-de-suma-cero/)
