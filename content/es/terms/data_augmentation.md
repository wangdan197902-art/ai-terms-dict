...
status: published
language: es
description: El aumento de datos es una técnica utilizada para aumentar la diversidad
  y el tamaño de los conjuntos de datos de entrenamiento aplicando transformaciones
  a los puntos de datos existentes.
---
## Definition
