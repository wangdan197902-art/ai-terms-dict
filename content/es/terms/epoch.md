...
status: published
language: es
description: Un pase completo del conjunto de datos de entrenamiento a través del
  algoritmo de aprendizaje automático durante el entrenamiento del modelo.
---
## Definition
