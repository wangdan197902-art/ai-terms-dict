...
status: published
language: es
description: Una técnica que separa las variables estocásticas de los parámetros aprendibles
  para permitir la optimización basada en gradientes en la inferencia variacional.
---
## Definition
