...
status: published
language: es
description: La divergencia se refiere al fallo de la función de pérdida de un algoritmo
  de aprendizaje automático para disminuir durante el entrenamiento, lo que resulta
  en un rendimiento inestable o empeorado.
---
## Definition
