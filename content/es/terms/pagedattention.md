...
status: published
language: es
description: PagedAttention es un algoritmo de gestión de memoria que adapta los conceptos
  de paginación de memoria virtual para optimizar el almacenamiento y acceso de las
  cachés de Clave-Valor (KV) en modelos tr
---
## Definition
