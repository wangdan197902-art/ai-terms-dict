...
status: published
language: nl
description: Een leeraanpak die generalisatie uitstelt tot het moment van classificatie,
  waarbij trainingsinstanties worden opgeslagen in plaats van een expliciet model
  te bouwen.
---
## Definition
