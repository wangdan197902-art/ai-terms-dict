...
Een Bayesiaanse methode voor variabelselectie die een mengprior gebruikt om nul- en niet-nulcoëfficiënten te onderscheiden.
...
- Analyse van hoogdimensionale genomische data
- Identificatie van risicofactoren in de financiële sector
- Functieselectie in voorspellende modellering

## Related Terms

- [Lasso (L1-regularisatie)](/en/terms/lasso-l1-regularisatie/)
- [Ridge-regressie (L2-regularisatie)](/en/terms/ridge-regressie-l2-regularisatie/)
- [Bayesiaanse lineaire regressie](/en/terms/bayesiaanse-lineaire-regressie/)
- [Sparceheid](/en/terms/sparceheid/)
