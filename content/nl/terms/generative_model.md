...
Een type machine learning-model dat de onderliggende verdeling van data leert om nieuwe, synthetische steekproeven te genereren die lijken op de trainingsdata.
...
- Generatie en bewerking van afbeeldingen
- Natuurlijke taalverwerking
- Dataverrijking voor kleine datasets

## Related Terms

- [Discriminative Model (Discriminatief model)](/en/terms/discriminative-model-discriminatief-model/)
- [Diffusion Model (Diffusiemodel)](/en/terms/diffusion-model-diffusiemodel/)
