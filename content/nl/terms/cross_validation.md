...
status: published
language: nl
description: Een hersteekproefprocedure die wordt gebruikt om machine learning-modellen
  te evalueren op een beperkte dataset door de data op te delen in subsets voor training
  en testen.
---
## Definition
