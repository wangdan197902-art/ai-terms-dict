...
status: published
language: nl
description: De initiële fase van het trainen van een machine learning-model op een
  grote, gelabelde dataset om algemene representaties te leren voordat er wordt gefinetuned
  op specifieke taken.
---
## Definition
