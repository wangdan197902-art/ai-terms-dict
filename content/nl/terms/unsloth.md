...
status: published
language: nl
description: Unsloth is een open-source bibliotheek die het trainen en infereren van
  Large Language Models (LLM's) tot wel 2x versnelt door geoptimaliseerd geheugenbeheer
  en kernel-implementaties.
---
## Definition
