...
status: published
language: nl
description: Few-shot prompting is een techniek waarbij aan LLM's een klein aantal
  invoer-uitvoervoorbeelden binnen de prompt worden gegeven om hun gedrag te sturen.
---
## Definition
