...
status: published
language: nl
description: Een Hugging Face Diffusers-pijplijnwrapper die het Stable Video Diffusion-model
  gebruikt om video's te genereren vanuit statische afbeeldingen.
---
## Definition
