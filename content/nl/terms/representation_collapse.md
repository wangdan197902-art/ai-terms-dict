...
status: published
language: nl
description: Een falingsmodus in zelfsuperviseerd leren waarbij het model identieke
  representaties uitvoert voor alle invoer, waardoor het discriminerend vermogen verloren
  gaat.
---
## Definition
