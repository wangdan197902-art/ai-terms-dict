...
بنية تحكم يتم فيها تنظيم اتخاذ القرار في طبقات، حيث تحدد المستويات العليا الأهداف للمستويات الأدنى.
...
- [PID Control (التحكم التناسبي التكاملي التفاضلي)](/en/terms/pid-control-التحكم-التناسبي-التكاملي-التفاضلي/)
- [State Machine (آلة الحالات)](/en/terms/state-machine-آلة-الحالات/)
- [Supervisory Control (التحكم الإشرافي)](/en/terms/supervisory-control-التحكم-الإشرافي/)
