...
يُرجح أن هذا المصطلح يشير إلى قدرات تقطيع الفيديو المرتبطة بإصدار من الجيل الثالث أو متغير محدد لنموذج Segment Anything المطبق على تدفقات الفيديو.
...
- القناع الديناميكي (Dynamic Masking)
...
- [SAM](/en/terms/sam/)
- [تقطيع كائنات الفيديو (Video Object Segmentation)](/en/terms/تقطيع-كائنات-الفيديو-video-object-segmentation/)
- [التتبع (Tracking)](/en/terms/التتبع-tracking/)
- [النماذج الزمنية (Temporal Models)](/en/terms/النماذج-الزمنية-temporal-models/)
