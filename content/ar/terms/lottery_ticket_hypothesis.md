...
status: published
language: ar
description: النظرية التي تفيد بأن الشبكات العصبية الكثيفة تحتوي على شبكات فرعية أصغر
  يمكنها، عند تدريبها بمعزل عن بعضها البعض من نقطة البداية، أن تطابق دقة الشبكة الأصلية.
---
## Definition
