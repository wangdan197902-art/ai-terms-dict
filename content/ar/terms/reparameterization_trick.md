...
aliases:
  - /ar/terms/reparameterization_trick/
...
status: "published"
language: "ar"
description: "تقنية تفصل المتغيرات العشوائية عن المعلمات القابلة للتعلم لتمكين التحسين القائم على التدرج في الاستدلال التبايني."
---
