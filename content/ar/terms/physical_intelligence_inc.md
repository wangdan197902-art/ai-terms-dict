...
شركة روبوتات أسسها باحثون سابقون من ديب مايند تركز على المناولة الروبوتية العامة.
...
- الروبوتات
- المناولة
- شركة تابعة لديب مايند

## Use Cases

- اللوجستيات الآلية في المستودعات
- مهام خطوط التجميع المعقدة
- الأبحاث حول وكلاء الروبوتات العامة

## Related Terms

- [Robot Learning (تعلم الروبوتات)](/en/terms/robot-learning-تعلم-الروبوتات/)
- [Sim-to-Real Transfer (النقل من المحاكاة إلى الواقع)](/en/terms/sim-to-real-transfer-النقل-من-المحاكاة-إلى-الواقع/)
- [Computer Vision (الرؤية الحاسوبية)](/en/terms/computer-vision-الرؤية-الحاسوبية/)
- [Actuators (المشغلات)](/en/terms/actuators-المشغلات/)
