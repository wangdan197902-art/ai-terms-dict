...
نهج نمذجة إحصائية يستخدم الاستدلال البايزي لتحليل السلاسل الزمنية إلى مكونات قابلة للتفسير.

## Key Concepts

- نماذج فضاء الحالة (State space models)
- الاستدلال السببي
- تحليل المكونات
- التوزيعات اللاحقة
...
- نمذجة مزيج التسويق
- التنبؤ الاقتصادي
- اختبار A/B باستخدام بيانات السلاسل الزمنية

## Related Terms

- [مرشح كالمان (Kalman filter)](/en/terms/مرشح-كالمان-kalman-filter/)
- [النمذجة بالمعادلات البنائية (Structural equation modeling)](/en/terms/النمذجة-بالمعادلات-البنائية-structural-equation-modeling/)
- [خوارزمية Prophet (Prophet)](/en/terms/خوارزمية-prophet-prophet/)
- [نماذج VAR (VAR models)](/en/terms/نماذج-var-var-models/)
