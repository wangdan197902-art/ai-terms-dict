...
status: published
language: cs
description: PagedAttention je algoritmus pro správu paměti, který přizpůsobuje koncepty
  virtuální paměti k optimalizaci ukládání a přístupu ke Key-Value (KV) cache v modelech
  typu Transformer.
---
## Definition
