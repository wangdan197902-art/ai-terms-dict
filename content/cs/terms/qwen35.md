...
Iterativní verze série velkých jazykových modelů Qwen zaměřená na vylepšené logické uvažování a vícejazyčné schopnosti.

## Key Concepts

- Iterativní zlepšování
- Podpora více jazyků
- Vylepšení logického uvažování
- Alibaba Cloud
...
- [Open Source Models (Modely s otevřeným zdrojovým kódem)](/en/terms/open-source-models-modely-s-otevřeným-zdrojovým-kódem/)
