...
status: published
language: cs
description: Teorie tvrdící, že husté neuronové sítě obsahují menší podsítě, které
  mohou při izolovaném tréninku od počátečního stavu dosáhnout přesnosti původní sítě.
---
## Definition
