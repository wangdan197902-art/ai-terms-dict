...
Google Clips byla kapesní kamera poháněná AI, která byla navržena k automatickému zachycování okamžiků pomocí strojového učení.

## Key Concepts

- Počítačové vidění
- Edge AI (AI na okraji sítě)
- Automatizovaná fotografie
- IoT (Internet věcí)

## Use Cases

- Běžná fotografie
- Sledování domácích mazlíčků
- Zachycování rodinných vzpomínek

## Related Terms

- [Smart Camera (chytrá kamera)](/en/terms/smart-camera-chytrá-kamera/)
- [Object Detection (detekce objektů)](/en/terms/object-detection-detekce-objektů/)
- [TensorFlow Lite (lehká verze TensorFlow)](/en/terms/tensorflow-lite-lehká-verze-tensorflow/)
