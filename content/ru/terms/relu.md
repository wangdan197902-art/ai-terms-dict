...
status: published
language: ru
description: Rectified Linear Unit (Ректифицированная линейная единица) — функция
  активации, которая выводит входное значение напрямую, если оно положительно, и ноль
  в противном случае.
---
## Definition
