...
aliases:
  - /ru/terms/long_short_term_memory/
...
status: "published"
language: "ru"
description: "Специализированная архитектура рекуррентной нейронной сети (RNN), предназначенная для изучения долгосрочных зависимостей в последовательных данных."
---
