...
status: published
language: ru
description: Ошибка моделирования, при которой алгоритм машинного обучения запоминает
  шум вместо основной закономерности, что ухудшает обобщающую способность.
---
## Definition
