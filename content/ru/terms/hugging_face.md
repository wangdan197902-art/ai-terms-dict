...
status: published
language: ru
description: Ведущая платформа и сообщество, предоставляющее инструменты с открытым
  исходным кодом, модели и наборы данных для разработки машинного обучения.
---
## Definition
