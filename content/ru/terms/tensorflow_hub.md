...
status: "published"
language: "ru"
description: "Репозиторий для переиспользования модулей машинного обучения, обеспечивающий трансферное обучение с помощью предварительно обученных моделей."
---
