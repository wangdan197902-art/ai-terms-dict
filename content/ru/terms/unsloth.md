...
status: published
language: ru
description: Unsloth — это библиотека с открытым исходным кодом, которая ускоряет
  обучение и инференс больших языковых моделей (LLM) до 2 раз за счет оптимизированного
  управления памятью и реализации ядер.
---
## Definition
