...
status: "published"
language: "ru"
description: "Few-shot промптинг — это техника, при которой большим языковым моделям предоставляется небольшое количество примеров ввода и вывода непосредственно в запросе для направления их поведения."
---
