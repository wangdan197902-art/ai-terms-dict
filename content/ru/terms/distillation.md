...
status: "published"
language: "ru"
description: "Дистилляция знаний — это техника сжатия модели, при которой меньшая модель-студент обучается имитировать поведение более крупной модели-учителя."
---
