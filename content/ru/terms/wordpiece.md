...
status: "published"
language: "ru"
description: "Алгоритм токенизации подслов, который рекурсивно объединяет наиболее часто встречающиеся пары символов для обработки слов, отсутствующих в словаре."
---
