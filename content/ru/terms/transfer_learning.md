...
status: "published"
language: "ru"
description: "Метод машинного обучения, при котором модель, разработанная для одной задачи, используется в качестве начальной точки для модели на второй задаче."
---
