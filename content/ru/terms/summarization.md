...
status: published
language: ru
description: Задача обработки естественного языка (NLP), заключающаяся в создании
  краткого и связного резюме длинного текста с сохранением его ключевой информации.
---
## Definition
