...
status: published
language: de
description: Eine Technik, die stochastische Variablen von lernbaren Parametern trennt,
  um eine gradientenbasierte Optimierung in der variationalen Inferenz zu ermöglichen.
---
## Definition
