...
status: published
language: de
description: PagedAttention ist ein Speicherverwaltungsalgorithmus, der Konzepte des
  virtuellen Speicher-Paging anpasst, um die Speicherung und den Zugriff auf Key-Value-(KV)-Caches
  in Transformer-Modellen zu opti
---
## Definition
