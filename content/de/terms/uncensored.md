...
Bezieht sich auf KI-Modelle, die so modifiziert wurden, dass sie Sicherheitsfilter und ethische Richtlinien umgehen.
...
- Forschung zu Modellverwundbarkeiten
- Kreatives Schreiben ohne Einschränkungen
- Testen von Sicherheitsgrenzen

## Related Terms

- [Jailbreaking (Umgehung von Sicherheitsprotokollen)](/en/terms/jailbreaking-umgehung-von-sicherheitsprotokollen/)
- [Alignment (Ausrichtung an menschlichen Werten)](/en/terms/alignment-ausrichtung-an-menschlichen-werten/)
- [RLHF (Reinforcement Learning from Human Feedback)](/en/terms/rlhf-reinforcement-learning-from-human-feedback/)
- [Safety Filters (Sicherheitsfilter)](/en/terms/safety-filters-sicherheitsfilter/)
