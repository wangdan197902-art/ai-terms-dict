...
Ein Paradigma des maschinellen Lernens, bei dem Modelle sequenziell aus neuen Daten lernen, ohne vorheriges Wissen zu vergessen.

## Key Concepts

- Katastrophales Vergessen
- Erfahrungswiederholung (Experience Replay)
- Regularisierungsmethoden
- Inkrementelles Lernen

## Use Cases

- Entwicklung personalisierter Assistenten
- Erwerb robotischer Fähigkeiten
- Anpassung der Betrugserkennung in Echtzeit

## Related Terms

- [Transferlernen (Transfer Learning)](/en/terms/transferlernen-transfer-learning/)
- [Few-Shot-Lernen](/en/terms/few-shot-lernen/)
- [Neuronale Plastizität](/en/terms/neuronale-plastizität/)
