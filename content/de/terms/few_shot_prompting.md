...
status: published
language: de
description: Few-Shot Prompting ist eine Technik, bei der Large Language Models (LLMs)
  im Prompt eine kleine Anzahl von Eingabe-Ausgabe-Beispielen erhalten, um ihr Verhalten
  zu steuern.
---
## Definition
