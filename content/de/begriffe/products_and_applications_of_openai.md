...
Ein Verweis auf das Portfolio an KI-Tools, APIs und Forschungsergebnissen, die von OpenAI entwickelt wurden, einschließlich GPT-Modellen und DALL-E.
...
- Automatisierte Code-Assistenz über GitHub Copilot
- Erstellung kreativer Inhalte für Marketingzwecke
- Konversationale Agenten für den Kundensupport

## Related Terms

- [gpt_models (GPT-Modelle)](/en/terms/gpt_models-gpt-modelle/)
- [dall_e (DALL-E)](/en/terms/dall_e-dall-e/)
- [chatgpt (ChatGPT)](/en/terms/chatgpt-chatgpt/)
- [generative_pretrained_transformer (Generativer vortrainierter Transformer)](/en/terms/generative_pretrained_transformer-generativer-vortrainierter-transformer/)
