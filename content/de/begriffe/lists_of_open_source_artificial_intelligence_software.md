...
Kuratierte Sammlungen oder Verzeichnisse, die öffentlich verfügbare KI-Tools, Bibliotheken und Frameworks katalogisieren.

## Key Concepts

- Open Source
- Ressourcenkuratierung
- Community-Pflege
- Software-Entdeckung

## Use Cases

- Entdeckung von Forschungswerkzeugen
- Auswahl des Technologie-Stacks für Startups
- Sammeln von Bildungsressourcen

## Related Terms

- [awesome_list (Awesome List)](/en/terms/awesome_list-awesome-list/)
- [github_topics (GitHub-Themen)](/en/terms/github_topics-github-themen/)
- [open_source_ecosystem (Open-Source-Ökosystem)](/en/terms/open_source_ecosystem-open-source-ökosystem/)
- [ai_frameworks (KI-Frameworks)](/en/terms/ai_frameworks-ki-frameworks/)
