...
status: published
language: en
description: Early stopping is a regularization technique that halts the training
  process when the model's performance on a validation set begins to degrade, preventing
  overfitting.
---
## Definition
