...
A prefix indicating the presence of multiple instances, heads, or modalities within a system or model.
...
- Designing transformer-based models
- Integrating sensor data streams
- Building ensemble learning systems

## Related Terms

- [Multi-Head Attention](/en/terms/multi-head-attention/)
- [Multi-Modal](/en/terms/multi-modal/)
