...
The hardware, software, and network resources required to develop, train, and deploy artificial intelligence models at scale.
...
- Planning large-scale model training environments
- Optimizing cloud costs for AI workloads
- Building MLOps pipelines for production systems

## Related Terms

- [MLOps](/en/terms/mlops/)
- [Cloud Computing](/en/terms/cloud-computing/)
- [High-Performance Computing](/en/terms/high-performance-computing/)
