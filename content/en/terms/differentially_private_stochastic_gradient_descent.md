...
status: published
language: en
description: An optimization algorithm that modifies standard SGD by clipping gradients
  and adding noise to ensure the trained model satisfies differential privacy constraints.
---
## Definition
