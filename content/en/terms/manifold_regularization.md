...
status: published
language: en
description: A semi-supervised learning technique that assumes data lies on a low-dimensional
  manifold and regularizes the model based on this geometric structure.
---
## Definition
