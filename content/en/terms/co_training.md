...
status: published
language: en
description: Co-training is a semi-supervised learning algorithm where two views of
  the data are used to train separate classifiers that iteratively label unlabeled
  data for each other.
---
## Definition
