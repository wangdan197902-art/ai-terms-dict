...
The capability of an AI system to self-diagnose its internal state, performance issues, or errors without human intervention.
...
- Robotic systems detecting mechanical wear
- AI models identifying data drift internally

## Related Terms

- [Self-Healing Systems](/en/terms/self-healing-systems/)
- [Observability](/en/terms/observability/)
- [MLOps](/en/terms/mlops/)
- [Anomaly Detection](/en/terms/anomaly-detection/)
