...
status: published
language: en
description: Eager learning is a machine learning approach where the generalization
  function is learned during the training phase, allowing for fast prediction times
