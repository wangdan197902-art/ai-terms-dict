...
A field treating numerical computation problems as statistical inference tasks to quantify uncertainty in results.
...
- Error estimation in Monte Carlo simulations
- Safe hyperparameter tuning in ML

## Related Terms

- [Bayesian Optimization](/en/terms/bayesian-optimization/)
- [Gaussian Processes](/en/terms/gaussian-processes/)
- [Numerical Analysis](/en/terms/numerical-analysis/)
- [Uncertainty Calibration](/en/terms/uncertainty-calibration/)
