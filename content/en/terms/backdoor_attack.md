...
A security threat where malicious actors embed hidden triggers in AI models during training to cause specific misclassifications.
...
- Security testing of ML pipelines
- Developing defensive filters
- Auditing third-party models

## Related Terms

- [Adversarial Examples](/en/terms/adversarial-examples/)
- [Data Poisoning](/en/terms/data-poisoning/)
- [Model Robustness](/en/terms/model-robustness/)
- [Clean Label Attacks](/en/terms/clean-label-attacks/)
