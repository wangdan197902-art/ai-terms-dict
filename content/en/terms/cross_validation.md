...
status: published
language: en
description: A resampling procedure used to evaluate machine learning models on a
  limited data sample by partitioning data into subsets for training and testing.
---
## Definition
