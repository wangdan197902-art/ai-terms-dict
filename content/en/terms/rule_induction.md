...
A machine learning technique that automatically generates a set of logical rules from labeled training data to classify new instances.
...
- [decision_trees](/en/terms/decision_trees/)
- [interpretability](/en/terms/interpretability/)
- [symbolic_ai](/en/terms/symbolic_ai/)
- [association_rules](/en/terms/association_rules/)
