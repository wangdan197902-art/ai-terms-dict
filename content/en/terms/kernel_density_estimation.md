...
aliases:
  - /en/terms/kernel_density_estimation/
...
status: "published"
language: "en"
description: "A non-parametric method used to estimate the probability density function of a random variable based on a finite data sample."
---
