...
The combination of artificial intelligence with robotic process automation to handle complex, unstructured business processes.
...
- Automated invoice processing with OCR and validation
- Dynamic customer onboarding with identity verification
- Intelligent supply chain management adjusting to demand fluctuations

## Related Terms

- [rpa](/en/terms/rpa/)
- [machine_learning](/en/terms/machine_learning/)
- [process_mining](/en/terms/process_mining/)
- [hyperautomation](/en/terms/hyperautomation/)
