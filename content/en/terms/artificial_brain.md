...
A computational system designed to mimic the structure and function of the biological human brain, often using neural networks.
...
- Energy-efficient edge computing devices
- Advanced pattern recognition in medical imaging
- Real-time sensory processing in robotics

## Related Terms

- [neuromorphic_engineering](/en/terms/neuromorphic_engineering/)
- [deep_learning](/en/terms/deep_learning/)
- [cognitive_computing](/en/terms/cognitive_computing/)
- [brain_computer_interface](/en/terms/brain_computer_interface/)
