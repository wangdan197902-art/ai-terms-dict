...
Describes analysis or classification tasks that require distinguishing between subtle differences within a broad category.
...
- Species identification in ecology
- Product variant detection in e-commerce
- Facial expression micro-analysis

## Related Terms

- [classification](/en/terms/classification/)
- [visual_features](/en/terms/visual_features/)
- [hierarchy](/en/terms/hierarchy/)
- [granularity](/en/terms/granularity/)
