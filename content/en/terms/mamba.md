...
status: published
language: en
description: Mamba is a state space sequence model that offers linear-time inference
  while maintaining the performance of transformers on long-context tasks.
---
## Definition
