...
status: published
language: en
description: Data augmentation is a technique used to increase the diversity and size
  of training datasets by applying transformations to existing data points.
---
## Definition
