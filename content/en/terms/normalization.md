...
status: published
language: en
description: Normalization is a data preprocessing technique that scales numerical
  features to a standard range, typically between 0 and 1, to improve model convergence
  and performance.
---
## Definition
