...
A dataset derived from Yahoo Answers, containing user-generated questions and answers categorized into specific topics for semantic matching and classification.
...
- Training question classification models
- Semantic textual similarity benchmarks
- Analyzing informal language patterns

## Related Terms

- [AG News](/en/terms/ag-news/)
- [SNLI](/en/terms/snli/)
- [Text Classification](/en/terms/text-classification/)
- [Semantic Search](/en/terms/semantic-search/)
