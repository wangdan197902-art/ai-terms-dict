...
status: published
language: en
description: A principle in statistical learning that seeks to minimize the upper
  bound of the generalization error by balancing model fit and complexity.
---
## Definition
