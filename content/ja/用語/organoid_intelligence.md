...
情報処理のために生きた脳細胞と電子インターフェースを統合するハイブリッドコンピューティングのパラダイム。
...
- [ブレインコンピュータインターフェース (BCI)](/en/terms/ブレインコンピュータインターフェース-bci/)
- [ラボで培養された脳](/en/terms/ラボで培養された脳/)
- [ニューロモーフィックエンジニアリング](/en/terms/ニューロモーフィックエンジニアリング/)
