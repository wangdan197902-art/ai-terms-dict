...
Meta AIによって開発された大規模言語モデルのファミリー。オープンウェイトと強力なパフォーマンスで知られています。
...
- [transformer_architecture (トランスフォーマーアーキテクチャ)](/en/terms/transformer_architecture-トランスフォーマーアーキテクチャ/)
- [fine_tuning (ファインチューニング)](/en/terms/fine_tuning-ファインチューニング/)
- [generative_ai (生成AI)](/en/terms/generative_ai-生成ai/)
