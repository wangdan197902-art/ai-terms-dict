...
status: published
language: it
description: Un approccio all'apprendimento che ritarda la generalizzazione fino al
  momento della classificazione, memorizzando le istanze di addestramento invece di
