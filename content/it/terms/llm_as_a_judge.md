...
weight: 1
slug: llm_as_a_judge
date: '2026-07-18T16:07:09.391313Z'
lastmod: '2026-07-18T17:15:08.641473Z'
draft: false
source: agnes_llm
status: published
language: it
description: Un metodo per valutare gli output dei modelli linguistici di grandi dimensioni
  (LLM) utilizzando un altro LLM per assegnare punteggi o classificare le risposte
...
- [prompt_engineering (ingegneria dei prompt)](/en/terms/prompt_engineering-ingegneria-dei-prompt/)
- [model_alignment (allineamento del modello)](/en/terms/model_alignment-allineamento-del-modello/)
