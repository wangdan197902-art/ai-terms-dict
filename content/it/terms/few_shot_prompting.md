...
status: published
language: it
description: Il prompting few-shot è una tecnica in cui i modelli linguistici di grandi
  dimensioni (LLM) ricevono un piccolo numero di esempi input-output all'interno del
  prompt per guidarne il comportamento.
---
## Definition
