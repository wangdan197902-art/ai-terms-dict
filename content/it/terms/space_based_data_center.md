...
Una struttura di calcolo situata in orbita che sfrutta le condizioni spaziali, come l'energia solare e il raffreddamento nel vuoto, per un'elaborazione efficiente dei dati.
...
- Computing globale a bassa latenza
- Elaborazione dei dati satellitari
- Archiviazione su larga scala ad alta efficienza energetica

## Related Terms

- [LEO Satellites (Satelliti LEO)](/en/terms/leo-satellites-satelliti-leo/)
- [Edge Computing (Elaborazione ai margini della rete)](/en/terms/edge-computing-elaborazione-ai-margini-della-rete/)
- [Thermal Management (Gestione termica)](/en/terms/thermal-management-gestione-termica/)
- [Space Logistics (Logistica spaziale)](/en/terms/space-logistics-logistica-spaziale/)
