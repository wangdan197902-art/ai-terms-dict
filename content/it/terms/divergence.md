...
status: published
language: it
description: La divergenza si riferisce al fallimento della funzione di perdita di
  un algoritmo di machine learning nel diminuire durante l'addestramento, risultando
  in prestazioni instabili o peggiorate.
---
## Definition
