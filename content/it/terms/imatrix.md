...
status: published
language: it
description: Un algoritmo specifico utilizzato nell'addestramento di grandi modelli
  linguistici per calcolare matrici di importanza per un'ottimizzazione efficiente
  dei parametri.
---
## Definition
