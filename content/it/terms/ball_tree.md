...
status: published
language: it
description: Una struttura dati ad albero binario utilizzata per organizzare i punti
  nello spazio, ottimizzando le ricerche dei vicini più prossimi in dataset ad alta
  dimensionalità.
---
## Definition
