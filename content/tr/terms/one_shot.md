...
Bir modelin tek bir etiketli örnekle bir görevi öğrenmesini sağlayan öğrenme paradigması.
...
- Sınırlı örnekle yüz tanıma
- El yazısı tanıma
- Nadir vakalardan tıbbi tanı

## Related Terms

- [few-shot (az örnekli öğrenme)](/en/terms/few-shot-az-örnekli-öğrenme/)
- [zero-shot (sıfır örnekli öğrenme)](/en/terms/zero-shot-sıfır-örnekli-öğrenme/)
- [meta-learning (meta öğrenme)](/en/terms/meta-learning-meta-öğrenme/)
- [siamese networks (siyami ağlar)](/en/terms/siamese-networks-siyami-ağlar/)
