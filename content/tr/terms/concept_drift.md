...
Kavram kayması, hedef değişkenin istatistiksel özelliklerinin zamanla değişmesi ve bu durumun model performansını düşürmesi olayıdır.

## Key Concepts

- Veri Dağılımı Kayması
- Model Bozulması
- Çevrimiçi Öğrenme
- Yeniden Eğitim
...
- Hisse senedi piyasa tahmini
- Müşteri kaybı modellemesi

## Related Terms

- [Veri Kayması](/en/terms/veri-kayması/)
- [Eş Değişken Kayması](/en/terms/eş-değişken-kayması/)
- [Model İzleme](/en/terms/model-i-zleme/)
- [Uyarlanabilir Öğrenme](/en/terms/uyarlanabilir-öğrenme/)
