...
Ortak dağılımın, birden fazla bağımsız uzman modelinin çıktılarının çarpılmasıyla oluşturulduğu olasılıksal modelleme çerçevesi.

## Key Concepts

- Enerjiye Dayalı Modeller
- Ortak Dağılım
- Çarpımsal Birleşim
- Kısıt Sağlama
...
- Görüntü doku sentezi ve modelleme
- Derin Boltzman Makineleri
- Jeneratif modellerde karmaşık bağımlılık modellemesi

## Related Terms

- [mixture_of_experts (uzmanların karışımı)](/en/terms/mixture_of_experts-uzmanların-karışımı/)
- [energy_based_model (enerjiye dayalı model)](/en/terms/energy_based_model-enerjiye-dayalı-model/)
- [deep_boltzmann_machine (derin boltzman makinesi)](/en/terms/deep_boltzmann_machine-derin-boltzman-makinesi/)
- [joint_probability (ortak olasılık)](/en/terms/joint_probability-ortak-olasılık/)
