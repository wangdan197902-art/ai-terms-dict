...
Makine algısı, yapay zeka sistemlerinin görüntüler, ses veya sensör okumaları gibi ortamdan gelen duyusal verileri yorumlama ve anlama yeteneğidir.
...
- Sesli asistan etkileşimi
- Tıbbi görüntü analizi

## Related Terms

- [Bilgisayarlı Görü (Computer Vision)](/en/terms/bilgisayarlı-görü-computer-vision/)
- [Doğal Dil İşleme (Natural Language Processing)](/en/terms/doğal-dil-i-şleme-natural-language-processing/)
- [Sensörler (Sensors)](/en/terms/sensörler-sensors/)
- [Sinyal İşleme (Signal Processing)](/en/terms/sinyal-i-şleme-signal-processing/)
