...
Eğitim sonrası, önceden eğitilmiş bir modeli belirli veri kümeleri üzerinde ince ayarlayarak belirli görevlere uyarlamak veya performansını optimize etmek için kullanılan aşamayı ifade eder.

## Key Concepts

- İnce ayar
- İnsan tercihleriyle hizalama (RLHF)
- Kuantizasyon
- Uyarlanabilirlik

## Use Cases

- Büyük Dil Modellerini (LLM) insan tercihleriyle hizalama
- Kenar cihazları için model boyutunu optimize etme
- Tıbbi tanı için modelleri özelleştirme

## Related Terms

- [pre_trained (ön eğitilmiş)](/en/terms/pre_trained-ön-eğitilmiş/)
- [fine_tuning (ince ayar)](/en/terms/fine_tuning-ince-ayar/)
- [alignment (hizalama)](/en/terms/alignment-hizalama/)
- [quantization (kuantizasyon)](/en/terms/quantization-kuantizasyon/)
