...
FP8, derin öğrenme eğitimini ve çıkarımını hızlandırmak için kabul edilebilir hassasiyet seviyelerini koruyarak tasarlanmış 8 bitlik kayan nokta formatıdır.
...
- [mixed_precision (karışık_hassasiyet)](/en/terms/mixed_precision-karışık_hassasiyet/)
