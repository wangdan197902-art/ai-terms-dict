...
Donald Michie tarafından 1961'de, kibrit kutuları ve boncuklar kullanarak Tık-Tak-Toe oynamak üzere inşa edilmiş fiziksel bir pekiştirmeli öğrenme cihazı.
...
- RL eğitim gösterileri
- Yapay zeka tarihi çalışmaları
- Ödül tabanlı öğrenme kavramlaştırma

## Related Terms

- [Pekiştirmeli öğrenme (Reinforcement learning)](/en/terms/pekiştirmeli-öğrenme-reinforcement-learning/)
- [Q-öğrenme (Q-learning)](/en/terms/q-öğrenme-q-learning/)
- [Donald Michie (Donald Michie)](/en/terms/donald-michie-donald-michie/)
- [Tık-Tak-Toe Yapay Zekası (Tic-Tac-Toe AI)](/en/terms/tık-tak-toe-yapay-zekası-tic-tac-toe-ai/)
