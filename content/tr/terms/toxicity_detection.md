...
Makine öğrenimi modelleri kullanarak metindeki zararlı veya saldırgan dili otomatik olarak tanımlama ve sınıflandırma süreci.
...
- Gerçek zamanlı sohbet filtreleme
- Marka itibarı izleme

## Related Terms

- [Duygu Analizi](/en/terms/duygu-analizi/)
- [Spam Algılama](/en/terms/spam-algılama/)
- [Zararlı İçerik](/en/terms/zararlı-i-çerik/)
