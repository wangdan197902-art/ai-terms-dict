...
Metin açıklamalarından yüksek kaliteli görselleri verimli bir şekilde oluşturabilen bir gizli yayılım modelidir.

## Key Concepts

- Gizli Yayılım (Latent Diffusion)
- Metinden Görüntüye (Text-to-Image)
- Üretken Yapay Zeka
- VAE (Değişken Otomatik Kodlayıcı)

## Use Cases

- Dijital sanat yaratımı
- Konsept görselleştirme
- Pazarlama için içerik üretimi
...
- [GAN'ler (Üretici Çekişmeli Ağlar)](/en/terms/gan-ler-üretici-çekişmeli-ağlar/)
