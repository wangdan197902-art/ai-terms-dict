...
Mamba, uzun bağlam görevlerinde dönüştürücülerle (transformer) eşleşen performans sunarken doğrusal zamanlı çıkarım sağlayan bir durum uzayı sıralı modelidir.

## Key Concepts

- Seçici Durum Uzay Modelleri
- Doğrusal Karmaşıklık
- Donanım Bilinçli Mimari
- Uzun Bağlam İşleme

## Use Cases

- Uzun belge özetleme
- Genom dizisi analizi
- Yüksek frekanslı zaman serisi tahmini

## Related Terms

- [Transformer (Dönüştürücü)](/en/terms/transformer-dönüştürücü/)
- [RNN (Tekrarlayan Sinir Ağı)](/en/terms/rnn-tekrarlayan-sinir-ağı/)
- [SSM (Durum Uzayı Modeli)](/en/terms/ssm-durum-uzayı-modeli/)
- [Attention Mechanism (Dikkat Mekanizması)](/en/terms/attention-mechanism-dikkat-mekanizması/)
