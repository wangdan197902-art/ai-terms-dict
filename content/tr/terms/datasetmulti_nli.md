...
Çok Türden Doğal Dil Çıkarım Korpusu, metin çıkarımı için insan tarafından doğrulanmış etiketlere sahip milyonlarca insan tarafından yazılmış İngilizce cümle içeren büyük bir veri setidir.

## Key Concepts

- Doğal Dil Çıkarımı
- Metin Çıkarımı
- GLUE Referans Ölçümü
- Anlamsal Benzerlik

## Use Cases

- Anlamsal anlayışın değerlendirilmesi
- NLI modellerinin eğitimi
- Türler arası genelleştirme testi

## Related Terms

- [SNLI (Standart Doğal Dil Çıkarım Korpusu)](/en/terms/snli-standart-doğal-dil-çıkarım-korpusu/)
- [GLUE (Doğal Dil İşleme Genel Referans Ölçümü)](/en/terms/glue-doğal-dil-i-şleme-genel-referans-ölçümü/)
- [Entailment (Çıkarım)](/en/terms/entailment-çıkarım/)
- [Contradiction (Çelişki)](/en/terms/contradiction-çelişki/)
