...
Ön eğitilmiş modeller, belirli görevler için uyarlanmadan önce geniş özellikleri öğrenmek üzere büyük veri setlerinde eğitilmiş sinir ağlarıdır.
...
- LLM'ler kullanarak sohbet botları oluşturma
- ResNet kullanarak görüntü sınıflandırma
- BERT ile duygu analizi

## Related Terms

- [post_training (eğitim sonrası)](/en/terms/post_training-eğitim-sonrası/)
- [foundation_model (temel model)](/en/terms/foundation_model-temel-model/)
- [transfer_learning (transfer öğrenmesi)](/en/terms/transfer_learning-transfer-öğrenmesi/)
- [weights (ağırlıklar)](/en/terms/weights-ağırlıklar/)
