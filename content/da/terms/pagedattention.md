...
status: published
language: da
description: PagedAttention er en algoritme til hukommelseshåndtering, der tilpasser
  koncepter fra virtuel hukommelsespaging til at optimere lagring og adgang til Key-Value
  (KV)-caches i transformer-modeller.
---
## Definition
