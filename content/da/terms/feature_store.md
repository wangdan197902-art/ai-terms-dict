...
Et centralt lager designet til at administrere, dele og levere funktioner konsistent på tværs af maskinlærings træning og inferens.

## Key Concepts

- Skævhed mellem træning og levering
- Centraliseret administration
- Versionshåndtering af funktioner
- MLOps-infrastruktur

## Use Cases

- Virksomhedsplatforme til maskinlæring
- Realtidssystemer til bedrageridetektion
- Samarbejdende hold til modelludvikling

## Related Terms

- [MLOps](/en/terms/mlops/)
- [Datapipeline](/en/terms/datapipeline/)
- [Modellevering](/en/terms/modellevering/)
- [Funktionskonstruktion](/en/terms/funktionskonstruktion/)
