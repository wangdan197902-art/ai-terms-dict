...
status: published
language: da
description: Datatæring opstår, når information uden for træningsdatasættet utilsigtet
  påvirker modellen, hvilket fører til for optimistiske præstationsvurderinger.
---
## Definition
