...
En kompromisløsning, hvor gevinsten i ét område medfører et tab i et andet.
...
- Valg af modelstørrelse til edge-enheder
- Balancering af inferenslatens med forudsigelsesnøjagtighed
- Håndtering af hukommelsesforbrug under træning

## Related Terms

- [optimization (optimering)](/en/terms/optimization-optimering/)
- [hyperparameter_tuning (finjustering af hyperparametre)](/en/terms/hyperparameter_tuning-finjustering-af-hyperparametre/)
- [model_compression (modelkomprimering)](/en/terms/model_compression-modelkomprimering/)
