...
status: published
language: da
description: Divergens refererer til svigtet i en maskinlæringsalgoritmes tabfunktion
  (loss function) i at falde under træningen, hvilket resulterer i ustabil eller forværrende
  ydeevne.
---
## Definition
