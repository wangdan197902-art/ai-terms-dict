...
Gemma er en familie af letvægts, banebrydende åbne modeller udviklet af Google DeepMind baseret på Gemini-forskning og -teknologi.
...
- Lokal udrulning af store sprogmodeller
- Prototyping til forskning
- Anvendelser inden for edge computing

## Related Terms

- [LLM (Large Language Model)](/en/terms/llm-large-language-model/)
- [Gemini](/en/terms/gemini/)
- [Open Source AI (Åben kildekode kunstig intelligens)](/en/terms/open-source-ai-åben-kildekode-kunstig-intelligens/)
