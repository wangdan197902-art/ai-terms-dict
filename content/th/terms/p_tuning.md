...
status: published
language: th
description: พี-ทูนิง เป็นวิธีการปรับแต่งโมเดลแบบประหยัดพารามิเตอร์ โดยทำการปรับปรุงค่าฝังตัว
  (embeddings) ของพรอมต์อย่างต่อเนื่อง แทนที่จะอัปเดตน้ำหนักของโมเดลที่ผ่านการฝึกฝนมาทั้งหมด
---
## Definition
