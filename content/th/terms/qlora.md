...
status: published
language: th
description: การปรับแต่งด้วยอันดับต่ำแบบควอนไทซ์ (Quantized Low-Rank Adaptation) เป็นวิธีการปรับแต่งโมเดลภาษาขนาดใหญ่อย่างมีประสิทธิภาพโดยใช้การควอนไทซ์แบบ
  4 บิตและอะแดปเตอร์อันดับต่ำ
---
## Definition
