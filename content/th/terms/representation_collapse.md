...
status: published
language: th
description: โหมดล้มเหลวในการเรียนรู้แบบกึ่งควบคุมตนเอง (self-supervised learning)
  ที่โมเดลส่งผลลัพธ์เป็นตัวแทนเดียวกันสำหรับข้อมูลนำเข้าทุกชุด ทำให้สูญเสียความสามารถในการแยกแยะ
---
## Definition
