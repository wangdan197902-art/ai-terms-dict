...
aliases:
  - /th/terms/multiple_instance_learning/
...
status: "published"
language: "th"
description: "รูปแบบการเรียนรู้แบบกึ่งควบคุม (weakly supervised) ที่กำหนดป้ายกำกับให้กับกลุ่มของข้อมูล (bags) แทนที่จะกำหนดให้กับข้อมูลแต่ละชิ้น"
---
