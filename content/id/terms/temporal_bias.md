...
Kesalahan sistematis di mana model memprioritaskan data terbaru dibandingkan konteks historis, yang menyebabkan prediksi yang menyimpang.
...
- Ketidakstasioneran
- Efek kebaruan
- Penurunan kinerja model

## Use Cases

- Prediksi pasar keuangan
- Analisis tren media sosial
- Pemodelan tingkat churn

## Related Terms

- [Concept drift (Drift konsep)](/en/terms/concept-drift-drift-konsep/)
- [Catastrophic forgetting (Pelupaan katastrofik)](/en/terms/catastrophic-forgetting-pelupaan-katastrofik/)
- [Time-series analysis (Analisis deret waktu)](/en/terms/time-series-analysis-analisis-deret-waktu/)
- [Fairness in AI (Keadilan dalam AI)](/en/terms/fairness-in-ai-keadilan-dalam-ai/)
