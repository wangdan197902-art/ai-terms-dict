...
status: published
language: id
description: Pembungkus (wrapper) pipeline Hugging Face Diffusers yang memanfaatkan
  model Stable Video Diffusion untuk menghasilkan video dari gambar statis.
---
## Definition
