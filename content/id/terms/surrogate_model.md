...
status: published
language: id
description: Model matematika sederhana yang digunakan untuk memperkirakan perilaku
  model kotak hitam yang lebih kompleks, mahal secara komputasi, atau tidak dapat
  diakses.
---
## Definition
