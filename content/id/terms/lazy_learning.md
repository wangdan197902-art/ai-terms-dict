...
status: published
language: id
description: Pendekatan pembelajaran yang menunda generalisasi hingga waktu klasifikasi,
  dengan menyimpan instance pelatihan daripada membangun model eksplisit.
---
## Definition
