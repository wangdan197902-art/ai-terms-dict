...
Dataset khusus yang dihosting oleh pengguna Jackrong di Hugging Face, dikurasi untuk penyetelan halus (fine-tuning) model bahasa besar seperti Qwen guna meningkatkan kemampuan penalaran kompleks.

## Key Concepts

- Penyetelan Halus Terawasi (Supervised Fine-Tuning)
...
- Menyetel halus LLM untuk tugas matematika atau logika
- Pengukuran peningkatan kemampuan penalaran
- Membuat asisten penalaran khusus

## Related Terms

- [Rantai Pemikiran (Chain-of-Thought)](/en/terms/rantai-pemikiran-chain-of-thought/)
- [Penyetelan Halus Terawasi (Supervised Fine-Tuning)](/en/terms/penyetelan-halus-terawasi-supervised-fine-tuning/)
- [Qwen](/en/terms/qwen/)
- [Dataset Hugging Face](/en/terms/dataset-hugging-face/)
