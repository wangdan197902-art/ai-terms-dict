...
status: published
language: id
description: Quantized Low-Rank Adaptation, sebuah metode untuk menyetel ulang (fine-tuning)
  model bahasa besar secara efisien menggunakan kuantisasi 4-bit dan adapter berderajat
  rendah.
---
## Definition
