...
status: published
language: id
description: Normalisasi batch adalah teknik yang menormalisasi input lapisan di seluruh
  mini-batch untuk menstabilkan dan mempercepat pelatihan jaringan saraf.
---
## Definition
