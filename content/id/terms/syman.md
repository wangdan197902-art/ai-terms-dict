...
Istilah non-standar atau ambigu dalam literatur AI; kemungkinan salah ketik untuk 'System' atau akronim khusus yang tidak dikenal luas dalam terminologi AI umum.

## Key Concepts

- Istilah Tidak Terdefinisi
- Kemungkinan Salah Ketik
- Ketergantungan Konteks

## Use Cases

- Permintaan klarifikasi dalam dokumentasi teknis
- Koreksi ejaan dalam pra-pemrosesan NLP

## Related Terms

- [Sistem Prompt (System Prompt)](/en/terms/sistem-prompt-system-prompt/)
- [Ambiguitas (Ambiguity)](/en/terms/ambiguitas-ambiguity/)
- [Kesalahan Terminologi (Terminology Error)](/en/terms/kesalahan-terminologi-terminology-error/)
