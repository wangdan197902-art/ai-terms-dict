...
status: published
language: id
description: Algoritma optimasi yang memodifikasi SGD standar dengan melakukan kliping
  gradien dan menambahkan noise untuk memastikan model yang dilatih memenuhi batasan
  privasi diferensial.
---
## Definition
