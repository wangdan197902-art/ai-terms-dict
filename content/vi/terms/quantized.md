...
status: "published"
language: "vi"
description: "Lượng tử hóa đề cập đến các mô hình mạng nơ-ron nơi trọng số và kích hoạt được biểu diễn bằng các số có độ chính xác thấp hơn để giảm kích thước và độ trễ."
---
