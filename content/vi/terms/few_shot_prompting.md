...
status: published
language: vi
description: Gợi ý ít ví dụ là kỹ thuật cung cấp cho các mô hình ngôn ngữ lớn (LLM)
  một số lượng nhỏ các ví dụ đầu vào-đầu ra trong lời nhắc để hướng dẫn hành vi của
  chúng.
---
## Definition
