...
status: "published"
language: "vi"
description: "Rust là một ngôn ngữ lập trình hệ thống tập trung vào tính an toàn, tốc độ và khả năng xử lý đồng thời mà không cần thu gom rác (garbage collection)."
---
