...
status: "published"
language: "vi"
description: "Một thủ tục lấy mẫu lại được sử dụng để đánh giá hiệu suất của các mô hình học máy trên một tập dữ liệu hạn chế bằng cách chia dữ liệu thành các tập con để huấn luyện và kiểm tra."
---
