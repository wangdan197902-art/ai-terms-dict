...
aliases:
  - /vi/terms/expectation_propagation/
...
status: "published"
language: "vi"
description: "Một thuật toán suy luận xấp xỉ được sử dụng để ước lượng các phân phối hậu nghiệm trong các mô hình đồ thị xác suất phức tạp."
---
