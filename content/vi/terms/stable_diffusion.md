...
Một mô hình khuếch tán tiềm năng có khả năng tạo ra hình ảnh chất lượng cao từ mô tả văn bản một cách hiệu quả.
...
- AI tạo sinh
- VAE (Mã tự biến đổi Variational)

## Use Cases

- Sáng tạo nghệ thuật kỹ thuật số
- Trực quan hóa khái niệm
- Tạo nội dung cho marketing

## Related Terms

- [DALL-E](/en/terms/dall-e/)
- [Midjourney](/en/terms/midjourney/)
- [Diffusion Models (Các mô hình khuếch tán)](/en/terms/diffusion-models-các-mô-hình-khuếch-tán/)
- [GANs (Mạng đối kháng sinh trưởng)](/en/terms/gans-mạng-đối-kháng-sinh-trưởng/)
