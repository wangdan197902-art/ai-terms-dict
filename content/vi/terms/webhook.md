...
status: "published"
language: "vi"
description: "Một lệnh gọi lại HTTP do người dùng xác định, được kích hoạt bởi các sự kiện cụ thể, cho phép các hệ thống đẩy thông báo thời gian thực đến các ứng dụng khác."
---
