...
status: "published"
language: "vi"
description: "P-Tuning là một phương pháp tinh chỉnh hiệu quả về tham số, tối ưu hóa các embedding của lời nhắc liên tục thay vì cập nhật toàn bộ trọng số của mô hình đã huấn luyện trước."
---
