...
status: published
language: vi
description: Chưng cất kiến thức là một kỹ thuật nén mô hình, trong đó một mô hình
  nhỏ hơn (mô hình sinh viên) học cách bắt chước hành vi của một mô hình lớn hơn (mô
  hình giáo viên).
---
## Definition
