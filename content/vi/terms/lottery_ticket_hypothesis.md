...
status: published
language: vi
description: Lý thuyết cho rằng các mạng nơ-ron dày đặc chứa các mạng con nhỏ hơn,
  khi được huấn luyện độc lập từ trạng thái khởi tạo ban đầu, có thể đạt độ chính
  xác tương đương với mạng gốc.
---
## Definition
