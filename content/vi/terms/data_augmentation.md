...
status: published
language: vi
description: Data Augmentation (Tăng cường dữ liệu) là kỹ thuật sử dụng để tăng tính
  đa dạng và kích thước của tập dữ liệu huấn luyện bằng cách áp dụng các phép biến
  đổi lên các điểm dữ liệu hiện có.
---
## Definition
