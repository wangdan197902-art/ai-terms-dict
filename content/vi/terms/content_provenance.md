...
Hồ sơ có thể xác minh về nguồn gốc, lịch sử và quyền sở hữu của một tài sản số.
...
- Phát hiện deepfake do AI tạo ra
- Xác minh nguồn tin tức
- Bảo vệ quyền sở hữu trí tuệ

## Related Terms

- [Watermarking (Rõ nước kỹ thuật số)](/en/terms/watermarking-rõ-nước-kỹ-thuật-số/)
- [Digital Rights Management (Quản lý quyền kỹ thuật số)](/en/terms/digital-rights-management-quản-lý-quyền-kỹ-thuật-số/)
- [Fact-checking (Kiểm chứng thông tin)](/en/terms/fact-checking-kiểm-chứng-thông-tin/)
- [Blockchain (Công nghệ chuỗi khối)](/en/terms/blockchain-công-nghệ-chuỗi-khối/)
