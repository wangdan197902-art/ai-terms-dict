...
- [Vision-Language Model (비전-언어 모델: 이미지와 텍스트를 함께 이해하는 AI 모델)](/en/terms/vision-language-model-비전-언어-모델-이미지와-텍스트를-함께-이해하는-ai-모델/)
- [Optical Character Recognition (광학 문자 인식: 이미지 속 텍스트를 디지털 텍스트로 변환하는 기술)](/en/terms/optical-character-recognition-광학-문자-인식-이미지-속-텍스트를-디지털-텍스트로-변환하는-기술/)
- [Multimodal Fusion (다중 모달 융합: 서로 다른 유형의 데이터를 통합하는 기법)](/en/terms/multimodal-fusion-다중-모달-융합-서로-다른-유형의-데이터를-통합하는-기법/)
- [Natural Language Processing (자연어 처리: 컴퓨터가 인간 언어를 이해하고 처리하는 기술)](/en/terms/natural-language-processing-자연어-처리-컴퓨터가-인간-언어를-이해하고-처리하는-기술/)
