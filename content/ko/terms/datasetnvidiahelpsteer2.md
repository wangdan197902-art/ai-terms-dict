...
- [보상 모델 (인간의 선호도를 예측하는 모델)](/en/terms/보상-모델-인간의-선호도를-예측하는-모델/)
- [DPO (직접 선호도 최적화)](/en/terms/dpo-직접-선호도-최적화/)
- [Anthropic HH (Anthropic의 Helpful-Harmless 데이터셋)](/en/terms/anthropic-hh-anthropic의-helpful-harmless-데이터셋/)
