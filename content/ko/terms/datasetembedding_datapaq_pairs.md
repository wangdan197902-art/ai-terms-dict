...
- [DPR (Dense Passage Retrieval - 밀도 있는 문서 검색 기법)](/en/terms/dpr-dense-passage-retrieval-밀도-있는-문서-검색-기법/)
- [Bi-Encoder (바이 인코더 - 쌍별 임베딩 생성 아키텍처)](/en/terms/bi-encoder-바이-인코더-쌍별-임베딩-생성-아키텍처/)
- [Knowledge Base (지식 기반 - 구조화된 정보 저장소)](/en/terms/knowledge-base-지식-기반-구조화된-정보-저장소/)
