...
다양한 장르의 자연어 추론을 위한 대규모 코퍼스. 수백만 건의 인간이 작성한 영어 문장과 텍스트 함양 관계에 대한 정밀한 인간 주석이 포함되어 있습니다.
...
- [SNLI (스탠다드 자연어 추론 데이터셋)](/en/terms/snli-스탠다드-자연어-추론-데이터셋/)
- [GLUE (일반 언어 이해 평가 벤치마크)](/en/terms/glue-일반-언어-이해-평가-벤치마크/)
- [함양 (전제가 가정을 논리적으로 지지하는 관계)](/en/terms/함양-전제가-가정을-논리적으로-지지하는-관계/)
- [모순 (전제와 가정이 서로 충돌하는 관계)](/en/terms/모순-전제와-가정이-서로-충돌하는-관계/)
