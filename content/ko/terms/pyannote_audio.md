...
- [pyannote (상위 라이브러리)](/en/terms/pyannote-상위-라이브러리/)
- [화자 Diarization(Speaker Diarization) (화자 식별 작업)](/en/terms/화자-diarization-speaker-diarization-화자-식별-작업/)
- [딥러닝(Deep Learning) (신경망을 활용한 기계 학습)](/en/terms/딥러닝-deep-learning-신경망을-활용한-기계-학습/)
- [Hugging Face Transformers (전송된 모델 라이브러리)](/en/terms/hugging-face-transformers-전송된-모델-라이브러리/)
