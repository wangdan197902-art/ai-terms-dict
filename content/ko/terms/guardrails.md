...
- [Alignment (정렬: AI의 목표와 인간 가치 간의 일치)](/en/terms/alignment-정렬-ai의-목표와-인간-가치-간의-일치/)
- [RLHF (강화학습을 통한 인간 피드백 정렬: 인간의 선호도를 반영하여 모델을 조정하는 방법)](/en/terms/rlhf-강화학습을-통한-인간-피드백-정렬-인간의-선호도를-반영하여-모델을-조정하는-방법/)
- [Content Moderation (콘텐츠 검열/모데레이션: 부적절한 콘텐츠를 식별하고 제거하는 과정)](/en/terms/content-moderation-콘텐츠-검열-모데레이션-부적절한-콘텐츠를-식별하고-제거하는-과정/)
- [Responsible AI (책임 있는 AI: 윤리적, 공정하며 안전한 AI 개발 및 사용 원칙)](/en/terms/responsible-ai-책임-있는-ai-윤리적-공정하며-안전한-ai-개발-및-사용-원칙/)
