...
- [Text Summarization (텍스트 요약 - 긴 텍스트를 짧은 형태로 변환)](/en/terms/text-summarization-텍스트-요약-긴-텍스트를-짧은-형태로-변환/)
- [Abstractive Compression (추상적 압축 - 내용을 재구성하여 축약)](/en/terms/abstractive-compression-추상적-압축-내용을-재구성하여-축약/)
- [Linguistic Efficiency (언어적 효율성 - 최소한의 언어 자원으로 최대의 의미 전달)](/en/terms/linguistic-efficiency-언어적-효율성-최소한의-언어-자원으로-최대의-의미-전달/)
