...
- [강화학습 (Reinforcement Learning): 보상을 최대화하도록 학습하는 머신러닝 패러다임](/en/terms/강화학습-reinforcement-learning-보상을-최대화하도록-학습하는-머신러닝-패러다임/)
- [RLHF (Human Feedback Reinforcement Learning): 인간의 피드백을 통해 언어 모델을 정렬하는 기술](/en/terms/rlhf-human-feedback-reinforcement-learning-인간의-피드백을-통해-언어-모델을-정렬하는-기술/)
- [Q-러닝 (Q-Learning): 상태와 행동의 가치(Q-value)를 학습하는 강화학습 알고리즘](/en/terms/q-러닝-q-learning-상태와-행동의-가치-q-value-를-학습하는-강화학습-알고리즘/)
