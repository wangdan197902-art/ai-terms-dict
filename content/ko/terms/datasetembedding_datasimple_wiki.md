---
title: "데이터셋: 임베딩 데이터/Simple Wiki"
...
- [Sentence Transformers (문장 트랜스포머 - 문장을 고정 크기 벡터로 변환하는 모델)](/en/terms/sentence-transformers-문장-트랜스포머-문장을-고정-크기-벡터로-변환하는-모델/)
- [Semantic Search (의미적 검색 - 의미 기반의 정보 검색)](/en/terms/semantic-search-의미적-검색-의미-기반의-정보-검색/)
