...
- [MultiNLI (다중 도메인 자연어 추론)](/en/terms/multinli-다중-도메인-자연어-추론/)
- [RTE (텍스트 함축 판별)](/en/terms/rte-텍스트-함축-판별/)
- [BERT (양방향 인코더 표현 모델)](/en/terms/bert-양방향-인코더-표현-모델/)
- [Semantic Role Labeling (의미 역할 레이블링)](/en/terms/semantic-role-labeling-의미-역할-레이블링/)
