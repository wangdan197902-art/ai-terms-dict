...
Datasiirtymä viittaa ilmiöön, jossa syötetiedon tilastolliset ominaisuudet muuttuvat koulutusvaiheen ja käyttöönoton välillä.
...
- Tuotannon ML-mallien seuranta
- Uudelleenkoulutusstrategiat
- Robustius-testaus

## Related Terms

- [Ylikoulutus (Overfitting)](/en/terms/ylikoulutus-overfitting/)
- [Alikoulutus (Underfitting)](/en/terms/alikoulutus-underfitting/)
- [Alueiden sovitus (Domain Adaptation)](/en/terms/alueiden-sovitus-domain-adaptation/)
- [Tietojen harha (Data Drift)](/en/terms/tietojen-harha-data-drift/)
