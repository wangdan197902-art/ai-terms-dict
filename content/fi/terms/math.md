...
Perustavanlaatuinen tieteenala, joka käsittelee lukuja, rakenteita, avaruutta ja muutoksia, ja joka on välttämätön tekoälyongelmien muotoilussa ja ratkaisemisessa.
...
- Takaisinpropagaatioalgoritmien johtaminen
- Ennusteiden epävarmuuden mallintaminen
- Häviöfunktioiden optimointi

## Related Terms

- [Lineaarialgebra (Linear Algebra)](/en/terms/lineaarialgebra-linear-algebra/)
- [Differentiaalilaskenta (Calculus)](/en/terms/differentiaalilaskenta-calculus/)
- [Tilastotiede (Statistics)](/en/terms/tilastotiede-statistics/)
- [Optimointi (Optimization)](/en/terms/optimointi-optimization/)
