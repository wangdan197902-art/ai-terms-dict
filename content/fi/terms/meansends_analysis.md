...
Heuristinen ongelmanratkaisumenetelmä, joka pienentää eroa nykytilan ja tavoitetilan välillä tunnistamalla alitavoitteita.

## Key Concepts

- Tilatilan haku
- Alitavoitteiden hajottaminen
- Heuristinen suunnittelu
- Erotuksen vähentäminen

## Use Cases

- Automaattinen lauseiden todistaminen
- Robotiikan reittisuunnittelu
- Monimutkaisten pulmien ratkaisu

## Related Terms

- [hill_climbing (mukavuudenhuipun kiipeily)](/en/terms/hill_climbing-mukavuudenhuipun-kiipeily/)
- [planning (suunnittelu)](/en/terms/planning-suunnittelu/)
- [state_space (tilatila)](/en/terms/state_space-tilatila/)
- [heuristics (heuristiikat)](/en/terms/heuristics-heuristiikat/)
