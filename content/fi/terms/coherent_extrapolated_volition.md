...
Ehdotettu tekoälyn tavoite, jossa järjestelmä toimii ihmiskunnan hienostuneiden toiveiden mukaisesti ideaalisen päättelyn jälkeen.

## Key Concepts

- Teoälyn kohdistaminen
- Arvojen oppiminen
- Idealisoituneet ihmistoiveet
- Hyötyfunktio

## Use Cases

- Yleisen tekoälyn (AGI) turvallisuuden teoreettinen viitekehys
- Eettiset ohjeistukset superälykkäille järjestelmille
- Filosofiset keskustelut koneen moraalista

## Related Terms

- [Teoälyn turvallisuus (AI Safety)](/en/terms/teoälyn-turvallisuus-ai-safety/)
- [Arvokohdistus (Value Alignment)](/en/terms/arvokohdistus-value-alignment/)
- [Superälykkyys (Superintelligence)](/en/terms/superälykkyys-superintelligence/)
- [Utilitarismi (Utilitarianism)](/en/terms/utilitarismi-utilitarianism/)
