...
Yhdistäminen tarkoittaa kahden datapisteryhmän tai piirteiden kohdistamista vastaavuuden, samankaltaisuuden tai optimaalisten parien tunnistamiseksi niiden välillä.

## Key Concepts

- Piirteiden vastaavuus
- Samankaltaisuusmittarit
- Upotustilat (embedding spaces)
- Lähin naapuri -haku

## Use Cases

- Kohteiden seuranta videossa
- Suositusmoottorit
- Duplicaatintunnistus tietokannoissa

## Related Terms

- [Cosine-samankaltaisuus](/en/terms/cosine-samankaltaisuus/)
- [Haku (retrieval)](/en/terms/haku-retrieval/)
