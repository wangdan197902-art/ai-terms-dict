...
Μια πολυτροπική ικανότητα Τεχνητής Νοημοσύνης που παράγει λεκτικές περιγραφές ή απαντήσεις με βάση εικόνες εισόδου και προαιρετικά κείμενα εντολών.
...
- Αυτόματος υποτιτλισμός εικόνων για προσβασιμότητα
- Συστήματα απάντησης σε οπτικές ερωτήσεις
- Ανάλυση διαχείρισης περιεχομένου

## Related Terms

- [Vision-Language Model (Μοντέλο Γλώσσας-Οράσεως)](/en/terms/vision-language-model-μοντέλο-γλώσσας-οράσεως/)
- [Optical Character Recognition (Αναγνώριση Χαρακτήρων OCR)](/en/terms/optical-character-recognition-αναγνώριση-χαρακτήρων-ocr/)
- [Multimodal Fusion (Ενσωμάτωση Πολυτροπικών Δεδομένων)](/en/terms/multimodal-fusion-ενσωμάτωση-πολυτροπικών-δεδομένων/)
