...
status: published
language: el
description: Η διαδικασία εξαγωγής σημαίνουσας πληροφορίας από ωμά δεδομένα για τη
  μείωση της διαστατικότητας και τη βελτίωση της απόδοσης των μοντέλων μηχανικής μάθησης.
---
## Definition
