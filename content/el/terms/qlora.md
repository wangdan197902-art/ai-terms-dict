...
status: "published"
language: "el"
description: "Quantized Low-Rank Adaptation, μια μέθοδος για την αποδοτική προσαρμογή μεγάλων γλωσσικών μοντέλων χρησιμοποιώντας κβάντιση 4-bit και προσαρμογείς χαμηλού βαθμού."
---
