...
aliases:
  - /el/terms/kernel_density_estimation/
...
status: "published"
language: "el"
description: "Μια μη παραμετρική μέθοδος που χρησιμοποιείται για την εκτίμηση της συνάρτησης πυκνότητας πιθανότητας μιας τυχαίας μεταβλητής με βάση ένα πεπερασμένο δείγμα δεδομένων."
---
