...
status: "published"
language: "el"
description: "Η ενίσχυση δεδομένων είναι μια τεχνική που χρησιμοποιείται για την αύξηση της ποικιλίας και του μεγέθους των συνόλων εκπαίδευσης εφαρμόζοντας μετασχηματισμούς στα υπάρχοντα σημεία δεδομένων."
---
