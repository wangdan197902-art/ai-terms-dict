...
Περιγράφει συστήματα ικανά να λαμβάνουν αποφάσεις και να δρουν ανεξάρτητα σε δυναμικά περιβάλλοντα.
...
- Αυτοκίνητα αυτονομίας
- Αυτόνομα drones
- Διαχείριση έξυπνων δικτύων ενέργειας

## Related Terms

- [Automated (Αυτοματοποιημένο)](/en/terms/automated-αυτοματοποιημένο/)
- [Reinforcement Learning (Ενισχυτική Μάθηση)](/en/terms/reinforcement-learning-ενισχυτική-μάθηση/)
- [Sensor Fusion (Σύγκλιση αισθητήρων)](/en/terms/sensor-fusion-σύγκλιση-αισθητήρων/)
