...
Ένα φιλοσοφικό πλαίσιο που χρησιμοποιείται στην ΤΕΠ για τη μοντελοποίηση των λογικών πρακτόρων βάσει των πεποιθήσεων, των επιθυμιών και των προθέσεών τους.

## Key Concepts

- Λογική πρακτικότητα
- Γνωστική αρχιτεκτονική
- Σκοποστραφής συμπεριφορά
- Εκτέλεση σχεδίου
...
- [Agent-oriented programming (Προγραμματισμός προσανατολισμένος σε πράκτορες)](/en/terms/agent-oriented-programming-προγραμματισμός-προσανατολισμένος-σε-πράκτορες/)
- [GOAL language (Γλώσσα GOAL)](/en/terms/goal-language-γλώσσα-goal/)
- [Rational choice theory (Θεωρία της λογικής επιλογής)](/en/terms/rational-choice-theory-θεωρία-της-λογικής-επιλογής/)
