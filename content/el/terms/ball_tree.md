...
status: "published"
language: "el"
description: "Μια δυαδική δομή δεδομένων δέντρου που χρησιμοποιείται για την οργάνωση σημείων στον χώρο, βελτιστοποιώντας τις αναζητήσεις γειτόνων σε σύνολα δεδομένων υψηλών διαστάσεων."
---
