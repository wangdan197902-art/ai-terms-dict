...
status: published
language: hu
description: A közös tanulás egy félig felügyelt tanuló algoritmus, ahol az adatok
  két nézetét használják fel különálló osztályozók tanításához, amelyek iteratívan
  címkézik egymás számára a címkézetlen adatokat.
---
## Definition
