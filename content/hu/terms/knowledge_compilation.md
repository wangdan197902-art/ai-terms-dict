...
A tudásfordítás az a folyamat, amely során a tudásrepresentációkat hatékonyabb formára alakítják a gyorsabb lekérdezések vagy következtetések érdekében.

## Key Concepts

- Logikai reprezentáció
- Lekérdezés optimalizálás
- Teljesíthetőség (Satisfiability)
- Előfeldolgozás

## Use Cases

- Automatikus tervező rendszerek
- Korlát-kielégítési problémák
- Valós idejű diagnosztikai rendszerek

## Related Terms

- [Logikai programozás](/en/terms/logikai-programozás/)
- [SAT oldók](/en/terms/sat-oldók/)
- [Ontológia](/en/terms/ontológia/)
- [Következtetés](/en/terms/következtetés/)
