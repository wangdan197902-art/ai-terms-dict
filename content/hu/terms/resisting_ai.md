...
Olyan stratégiák és technikák, amelyeket mesterséges intelligencia rendszerek általi észlelés, manipuláció vagy kontroll elkerülésére használnak.

## Key Concepts

- Ellenséges példák
- Magánszféra védelme
- Algoritmikus kijátszás
- Megfigyelés elleni védekezés

## Use Cases

- Ellenséges gépi tanulás kutatása
- Adatvédelmi eszközök fejlesztése
- Biztonsági piros sapkás tesztelés (Red Teaming)

## Related Terms

- [Ellenséges támadások](/en/terms/ellenséges-támadások/)
- [Adatvédelem](/en/terms/adatvédelem/)
- [Elhomályosítás (Obfuscation)](/en/terms/elhomályosítás-obfuscation/)
- [AI biztonság](/en/terms/ai-biztonság/)
