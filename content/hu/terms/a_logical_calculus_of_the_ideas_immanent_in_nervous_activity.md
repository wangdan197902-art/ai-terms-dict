...
McCulloch és Pitts 1943-as alapvető cikke, amely formalizálta, hogyan hajthatnak végre neuronok logikai műveleteket, és lerakta a mesterséges neurális hálózatok alapjait.

## Key Concepts

- McCulloch-Pitts neuron
- Boole-logika
- Hegypontú egységek (Threshold Units)
- Kapcsolatosság (Connectionism)

## Use Cases

- Történelmi kontextus az AI fejlődéséhez
- Neurális hálózatok tervezésének elméleti alapja
- A biológiai inspiráció megértése a számítástechnikában

## Related Terms

- [Mesterséges neuron](/en/terms/mesterséges-neuron/)
- [Perceptron](/en/terms/perceptron/)
- [Boole-algebra](/en/terms/boole-algebra/)
- [Kibernetika](/en/terms/kibernetika/)
