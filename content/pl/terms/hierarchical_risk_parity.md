...
Technika optymalizacji portfela wykorzystująca klasteryzację do obsługi korelacji między aktywami i alokacji ryzyka w ramach hierarchicznych klastrów.
...
- [Optymalizacja średnia-wariancja (Tradycyjna metoda Markowitza)](/en/terms/optymalizacja-średnia-wariancja-tradycyjna-metoda-markowitza/)
- [Model Black-Littermana (Łączenie widzeń z danymi rynkowymi)](/en/terms/model-black-littermana-łączenie-widzeń-z-danymi-rynkowymi/)
- [Analiza klastrowa (Metoda grupowania danych)](/en/terms/analiza-klastrowa-metoda-grupowania-danych/)
