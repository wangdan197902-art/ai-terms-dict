...
status: published
language: pl
description: Algorytm optymalizacji modyfikujący standardowy SGD poprzez obcinanie
  gradientów i dodawanie szumu, aby zapewnić spełnienie przez wytrenowany model ograniczeń
