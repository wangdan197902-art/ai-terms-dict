...
status: published
language: pl
description: vLLM to silnik wnioskowania o wysokiej przepustowości i efektywnym zużyciu
  pamięci dla dużych modeli językowych, wykorzystujący PagedAttention do optymalizacji
  użycia pamięci GPU.
---
## Definition
