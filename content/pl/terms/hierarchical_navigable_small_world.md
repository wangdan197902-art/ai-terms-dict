...
status: published
language: pl
description: Struktura danych oparta na grafie umożliwiająca wydajne przybliżone wyszukiwanie
  najbliższych sąsiadów w przestrzeniach o wysokiej wymiarowości.
---
## Definition
