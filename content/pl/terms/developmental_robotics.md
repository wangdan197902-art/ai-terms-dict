...
Międzydisciplinarne pole badawcze studiujące, jak roboty mogą nabywać złożone umiejętności poprzez interakcję ze środowiskiem i opiekunami.
...
- Motywacja intrynseiczna

## Use Cases

- Badania nad interakcją człowiek-robot
- Adaptywni asystenci robotyczni
- Modelowanie w naukach poznawczych

## Related Terms

- [Reinforcement Learning (Uczenie przez wzmacnianie)](/en/terms/reinforcement-learning-uczenie-przez-wzmacnianie/)
- [Embodied Cognition (Kognicja ucieleśniona)](/en/terms/embodied-cognition-kognicja-ucieleśniona/)
- [Motor Control (Kontrola ruchu)](/en/terms/motor-control-kontrola-ruchu/)
- [Social Robotics (Robotyka społeczna)](/en/terms/social-robotics-robotyka-społeczna/)
