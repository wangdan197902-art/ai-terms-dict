...
status: published
language: pl
description: P-Tuning to metoda dostrajania oszczędzająca parametry, która optymalizuje
  ciągłe osadzenia promptów zamiast aktualizować wagi całego modelu wstecznie wytrenowanego.
---
## Definition
