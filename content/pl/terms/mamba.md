...
status: published
language: pl
description: Mamba to model sekwencyjny oparty na przestrzeni stanów (state space),
  który zapewnia liniową złożoność czasową wnioskowania, zachowując jednocześnie wydajność
  transformatorów w zadaniach z długim kon
---
## Definition
