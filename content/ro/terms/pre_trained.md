...
- [post_training (post-antrenare)](/en/terms/post_training-post-antrenare/)
- [foundation_model (model de bază)](/en/terms/foundation_model-model-de-bază/)
- [transfer_learning (învățare prin transfer)](/en/terms/transfer_learning-învățare-prin-transfer/)
- [weights (greutăți)](/en/terms/weights-greutăți/)
