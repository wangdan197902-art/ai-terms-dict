...
status: published
language: ro
description: O structură de date tip arbore binar utilizată pentru organizarea punctelor
  în spațiu, optimizând căutările celor mai apropiati vecini în seturi de date cu
  dimensiuni mari.
---
## Definition
