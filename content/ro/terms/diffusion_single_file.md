...
status: published
language: ro
description: Un format de distribuție pentru modelele de difuzie în care toate ponderile
  modelului, configurațiile și uneori chiar codul de inferență sunt grupate într-un
  singur fișier pentru portabilitate ușoară.
---
## Definition
