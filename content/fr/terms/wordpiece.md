...
status: published
language: fr
description: Un algorithme de tokenisation par sous-mots qui fusionne récursivement
  les paires de caractères les plus fréquentes pour gérer les mots hors vocabulaire.
---
## Definition
