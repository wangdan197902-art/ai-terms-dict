...
status: published
language: fr
description: Le P-Tuning est une méthode d'ajustement fin efficace en paramètres qui
  optimise les embeddings de prompts continus plutôt que de mettre à jour l'ensemble
  des poids du modèle pré-entraîné.
---
## Definition
