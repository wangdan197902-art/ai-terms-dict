...
status: published
language: fr
description: La distillation de connaissances est une technique de compression de
  modèle où un petit modèle « élève » apprend à imiter le comportement d'un grand
  modèle « professeur ».
---
## Definition
