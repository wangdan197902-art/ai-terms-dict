...
status: published
language: fr
description: Une mesure de fréquence ou de vitesse, faisant couramment référence aux
  taux d'apprentissage dans l'optimisation ou aux vitesses de génération de tokens.
---
## Definition
