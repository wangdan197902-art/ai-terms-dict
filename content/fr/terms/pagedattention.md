...
status: published
language: fr
description: PagedAttention est un algorithme de gestion de la mémoire qui adapte
  les concepts de pagination de la mémoire virtuelle pour optimiser le stockage et
  l'accès aux caches Clé-Valeur (KV) dans les modèle
---
## Definition
