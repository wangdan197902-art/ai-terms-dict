...
status: published
language: fr
description: Une classe spécialisée de réseaux neuronaux profonds principalement utilisée
  pour traiter des données en grille, comme les images, en appliquant des filtres
  de convolution.
---
## Definition
