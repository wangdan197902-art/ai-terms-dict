...
status: published
language: fr
description: vLLM est un moteur d'inférence à haut débit et économe en mémoire pour
  les grands modèles de langage, utilisant la technique PagedAttention pour optimiser
