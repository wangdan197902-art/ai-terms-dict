...
status: published
language: fr
description: Une technique qui sépare les variables stochastiques des paramètres apprenables
  pour permettre l'optimisation basée sur les gradients dans l'inférence variationnelle.
---
## Definition
