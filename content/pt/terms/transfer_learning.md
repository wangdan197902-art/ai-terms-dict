...
status: published
language: pt
description: Uma técnica de aprendizado de máquina na qual um modelo desenvolvido
  para uma tarefa é reutilizado como ponto de partida para um modelo em uma segunda
  tarefa.
---
## Definition
