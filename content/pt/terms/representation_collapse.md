...
status: published
language: pt
description: Um modo de falha no aprendizado auto-supervisionado onde o modelo produz
  representações idênticas para todas as entradas, perdendo poder discriminativo.
---
## Definition
