...
status: published
language: pt
description: O modelo bolsa de palavras é uma representação simplificada de texto
  que descreve a ocorrência de palavras em um documento, ignorando gramática e ordem
  das palavras.
---
## Definition
