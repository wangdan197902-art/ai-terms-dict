...
Um erro sistemático onde os modelos priorizam dados recentes em detrimento do contexto histórico, levando a previsões distorcidas.
...
- [Concept drift (deriva conceitual)](/en/terms/concept-drift-deriva-conceitual/)
- [Catastrophic forgetting (esquecimento catastrófico)](/en/terms/catastrophic-forgetting-esquecimento-catastrófico/)
- [Time-series analysis (análise de séries temporais)](/en/terms/time-series-analysis-análise-de-séries-temporais/)
- [Fairness in AI (justiça na IA)](/en/terms/fairness-in-ai-justiça-na-ia/)
