...
status: published
language: pt
description: Uma arquitetura de aprendizado profundo baseada em mecanismos de autoatenção
  que processa dados sequenciais em paralelo, em vez de sequencialmente.
---
## Definition
