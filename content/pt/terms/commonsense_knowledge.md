...
As informações de fundo e a compreensão intuitiva do mundo físico e social que os humanos possuem, mas que as máquinas frequentemente carecem.
...
- Desambiguação em Processamento de Linguagem Natural
- Navegação e interação em robótica
