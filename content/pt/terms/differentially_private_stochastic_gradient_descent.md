...
status: published
language: pt
description: Um algoritmo de otimização que modifica a SGD padrão ao limitar os gradientes
  e adicionar ruído para garantir que o modelo treinado satisfaça as restrições de
