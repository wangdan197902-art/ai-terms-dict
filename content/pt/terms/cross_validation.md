...
status: published
language: pt
description: Um procedimento de reamostragem usado para avaliar modelos de aprendizado
  de máquina em uma amostra limitada de dados, dividindo-os em subconjuntos para treinamento
  e teste.
---
## Definition
