...
status: published
language: pt
description: Um sistema de reconhecimento automático de fala (ASR) desenvolvido pela
  OpenAI, treinado em um grande conjunto de dados diversificado de áudio.
---
## Definition
