...
status: published
language: pt
description: Uma estrutura de dados em árvore binária usada para organizar pontos
  no espaço, otimizando buscas por vizinhos mais próximos em conjuntos de dados de
