...
status: published
language: pt
description: Um wrapper de pipeline do Hugging Face Diffusers que utiliza o modelo
  Stable Video Diffusion para gerar vídeos a partir de imagens estáticas.
---
## Definition
