...
Uma arquitetura de controle onde a tomada de decisões é organizada em camadas, com níveis superiores definindo metas para controladores de nível inferior.
...
- [PID Control (Controle PID)](/en/terms/pid-control-controle-pid/)
- [State Machine (Máquina de Estados)](/en/terms/state-machine-máquina-de-estados/)
- [Supervisory Control (Controle Supervisório)](/en/terms/supervisory-control-controle-supervisório/)
