...
En beslutningsstrategi der en agent velger handlinger med frekvenser proporsjonale med deres estimerte sannsynligheter.
...
- Modellering av menneskelig atferd i psykologiske eksperimenter
- Robust utforskning i ikke-stasjonære multi-armet banditt-problemer
- Analyse av suboptimale læringsalgoritmer

## Related Terms

- [epsilon-greedy (epsilon-gjerrig strategi)](/en/terms/epsilon-greedy-epsilon-gjerrig-strategi/)
- [softmax_action_selection (myk maksimeringsvalg)](/en/terms/softmax_action_selection-myk-maksimeringsvalg/)
- [maximizing_strategy (maksimeringsstrategi)](/en/terms/maximizing_strategy-maksimeringsstrategi/)
- [exploration_bonus (utforskingsbonus)](/en/terms/exploration_bonus-utforskingsbonus/)
