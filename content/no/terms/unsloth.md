...
status: published
language: 'no'
description: Unsloth er et åpen kildekode-bibliotek som akselererer trening og inferens
  av store språkmodeller (LLM) med opptil 2x gjennom optimalisert minnehåndtering
  og tilpassede kjerneimplementeringer.
---
## Definition
