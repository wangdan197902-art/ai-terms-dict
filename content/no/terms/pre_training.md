...
status: published
language: 'no'
description: Den innledende fasen av treningen av en maskinlæringsmodell på et stort,
  umerket datasett for å lære generelle representasjoner før finjustering på spesifikke
  oppgaver.
---
## Definition
