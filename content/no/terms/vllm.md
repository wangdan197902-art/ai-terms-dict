...
status: published
language: 'no'
description: vLLM er en inferenstmotor med høy gjennomstrømning og minneeffektivitet
  for store språkmodeller, som bruker PagedAttention for å optimalisere GPU-minnebruk.
---
## Definition
