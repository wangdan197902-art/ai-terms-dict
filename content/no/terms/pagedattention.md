...
status: published
language: 'no'
description: PagedAttention er en minnehåndteringsalgoritme som tilpasser konseptene
  fra virtuell minnepaging for å optimalisere lagring og tilgang til Key-Value (KV)-cacher
  i transformer-modeller.
---
## Definition
